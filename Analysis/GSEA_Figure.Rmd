...
params:
  files: !r list(list("pos" = "~/gsea_home/output/may20/c_beta_measured.Gsea.1716224578513/gsea_report_for_c_beta_measured_pos_1716224578513.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_measured.Gsea.1716224578513/gsea_report_for_c_beta_measured_neg_1716224578513.tsv"),
                 list("pos" = "~/gsea_home/output/may20/c_beta_adj1.Gsea.1716224608018/gsea_report_for_c_beta_adj1_pos_1716224608018.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_adj1.Gsea.1716224608018/gsea_report_for_c_beta_adj1_neg_1716224608018.tsv"),
                 list("pos" = "~/gsea_home/output/may20/c_beta_measured_10.Gsea.1716224668303/gsea_report_for_c_beta_measured_pos_1716224668303.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_measured_10.Gsea.1716224668303/gsea_report_for_c_beta_measured_neg_1716224668303.tsv"),
                 list("pos" = "~/gsea_home/output/may20/c_beta_adj1_10.Gsea.1716224690931/gsea_report_for_c_beta_adj1_pos_1716224690931.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_adj1_10.Gsea.1716224690931/gsea_report_for_c_beta_adj1_neg_1716224690931.tsv"),
                 list("pos" = "~/gsea_home/output/may20/c_beta_measured_103.Gsea.1716225205429/gsea_report_for_c_beta_measured_pos_1716225205429.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_measured_103.Gsea.1716225205429/gsea_report_for_c_beta_measured_neg_1716225205429.tsv"),
                 list("pos" = "~/gsea_home/output/may20/c_beta_measured_103.Gsea.1716225207070/gsea_report_for_c_beta_measured_pos_1716225207070.tsv",
                      "neg" = "~/gsea_home/output/may20/c_beta_measured_103.Gsea.1716225207070/gsea_report_for_c_beta_measured_neg_1716225207070.tsv"))
  names: !r c("$C_{\\beta}$", "$C_{\\beta}^{\\alpha}$", 
              "$C_{\\beta}$", "$C_{\\beta}^{\\alpha}$", 
              "$C_{\\beta}$", "$C_{\\beta}$")
  fdr_limit: 0.1
---
...
### GSEA Figures Minimally Processed (genes with rowSums(counts) < 10 removed) {.tabset}
...
I recommend we use this cut-off. The FDR-limit, above which pathways are excluded, is `r params$fdr_limit`.
...
### GSEA Figures Randomization Effect {.tabset}
The FDR-limit, above which pathways are excluded, is `r params$fdr_limit`.
