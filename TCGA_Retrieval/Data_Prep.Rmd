...
write.table(clinical_final, paste0(save_path, 'cohort1.clinical.tsv'), sep='\t', quote=FALSE)
...
write.table(methyl, paste0(save_path, methyl_filename, '.tsv'), sep='\t', quote=FALSE)
